...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int mIndicatorMargin = 15;//indicator 圆点之间的举例
    ...
    private void readAttrs(Context context,AttributeSet attrs){
        ...
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.MZBannerView_indicatorMargin,15);
    }
        ...
        for(int i=0;i<mDatas.size();i++){
            ...
            if(mIndicatorAlign == IndicatorAlign.LEFT.ordinal()){
                if(i == 0){
                    ...
                    imageView.setPadding(paddingLeft+mIndicatorMargin,0,mIndicatorMargin,0);
                } else{
                    imageView.setPadding(mIndicatorMargin,0,mIndicatorMargin,0);
                }
                ...
                if(i == mDatas.size() - 1){
                    ...
                    imageView.setPadding(mIndicatorMargin,0,mIndicatorMargin + paddingRight,0);
                }else{
                    imageView.setPadding(mIndicatorMargin,0,mIndicatorMargin,0);
                }
